    ...
    <div class="container_" id="container_" tabindex="0" onfocus="closeSidebar()">
        ...
        <div class="cadastro">
            ...
            <form id = "formCadastro">
                <div class="row">
                    <input id="nome" class="col-md-7 col-sm-12 item" type="text" placeholder="Nome Completo" required>
                    <input id="cpf" class="col-md-4 item" type="text"  placeholder="CPF"  oninput="validarCPF(this); aplicarMascaraCPF(this)" maxlength="14" required>
                </div>

                <div class="row">
                    <input id="email" class="col-md-7 col-sm-12 item" type="email" placeholder="Email" required>
                    <input id="rg" class="col-md-4 col-sm-12 item" type="text"  placeholder="RG" oninput="validarRG(this); aplicarMascaraRG(this)" maxlength="12" required>
                ...
                <div class="row">
                    <div><input id="senha" class="col-md-3 col-sm-12 item" type="password" placeholder="Senha" required>
                        <button style="top: 1px;" type="button" class="botao" id="botao"><img class="olho" id="olho" src="../../public/imagens/aberto.png"></button></div>
                </div>
                
                <input id="enviar" type="submit" value="Enviar">
            </form>

            <p>Já tem uma conta? <a href="../login/login.php">Clique aqui</a> para realizar login.</p>
